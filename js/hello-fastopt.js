...
/** @constructor */
function $c_Lorg_dt_Main$() {
  $c_O.call(this)
}
$c_Lorg_dt_Main$.prototype = new $h_O();
$c_Lorg_dt_Main$.prototype.constructor = $c_Lorg_dt_Main$;
/** @constructor */
function $h_Lorg_dt_Main$() {
  /*<skip>*/
}
$h_Lorg_dt_Main$.prototype = $c_Lorg_dt_Main$.prototype;
$c_Lorg_dt_Main$.prototype.init___ = (function() {
  return this
});
$c_Lorg_dt_Main$.prototype.main__AT__V = (function(args) {
  $m_Lscoverage_Invoker$().invoked__I__T__V(13, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data");
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V(($m_Lscoverage_Invoker$().invoked__I__T__V(11, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data"), $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body), ($m_Lscoverage_Invoker$().invoked__I__T__V(12, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data"), "Hello World"));
  $m_Lscoverage_Invoker$().invoked__I__T__V(14, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data");
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Hello world!\n")
});
$c_Lorg_dt_Main$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  $m_Lscoverage_Invoker$().invoked__I__T__V(7, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data");
  var parNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("p");
  $m_Lscoverage_Invoker$().invoked__I__T__V(8, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data");
  parNode.textContent = text;
  $m_Lscoverage_Invoker$().invoked__I__T__V(9, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data");
  targetNode.appendChild(parNode);
  $m_Lscoverage_Invoker$().invoked__I__T__V(10, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data")
});
var $d_Lorg_dt_Main$ = new $TypeData().initClass({
  Lorg_dt_Main$: 0
}, false, "org.dt.Main$", {
  Lorg_dt_Main$: 1,
  O: 1
});
$c_Lorg_dt_Main$.prototype.$classData = $d_Lorg_dt_Main$;
var $n_Lorg_dt_Main$ = (void 0);
function $m_Lorg_dt_Main$() {
  if ((!$n_Lorg_dt_Main$)) {
    $n_Lorg_dt_Main$ = new $c_Lorg_dt_Main$().init___()
  };
  return $n_Lorg_dt_Main$
}
/** @constructor */
...
/** @constructor */
function $c_Lscalajssupport_File() {
  $c_O.call(this);
  this.$$undfile$1 = null
}
$c_Lscalajssupport_File.prototype = new $h_O();
$c_Lscalajssupport_File.prototype.constructor = $c_Lscalajssupport_File;
/** @constructor */
function $h_Lscalajssupport_File() {
  /*<skip>*/
}
$h_Lscalajssupport_File.prototype = $c_Lscalajssupport_File.prototype;
$c_Lscalajssupport_File.prototype.init___T__T = (function(path, child) {
  var this$1 = $m_Lscalajssupport_File$();
  $c_Lscalajssupport_File.prototype.init___T.call(this, this$1.jsFile$1.pathJoin__T__T__T(path, child));
  return this
});
$c_Lscalajssupport_File.prototype.toString__T = (function() {
  return this.$$undfile$1.getPath__T()
});
$c_Lscalajssupport_File.prototype.init___T = (function(path) {
  this.$$undfile$1 = $m_Lscalajssupport_File$().jsFile$1.apply__T__Lscalajssupport_JsFile(path);
  return this
});
var $d_Lscalajssupport_File = new $TypeData().initClass({
  Lscalajssupport_File: 0
}, false, "scalajssupport.File", {
  Lscalajssupport_File: 1,
  O: 1
});
$c_Lscalajssupport_File.prototype.$classData = $d_Lscalajssupport_File;
/** @constructor */
function $c_Lscalajssupport_File$() {
  $c_O.call(this);
  this.jsFile$1 = null
...
$h_Lscalajssupport_File$.prototype = $c_Lscalajssupport_File$.prototype;
$c_Lscalajssupport_File$.prototype.init___ = (function() {
  $n_Lscalajssupport_File$ = this;
  this.jsFile$1 = ($uZ($g.hasOwnProperty("Packages")) ? $m_Lscalajssupport_RhinoFile$() : ((!$uZ($g.hasOwnProperty("window"))) ? $m_Lscalajssupport_NodeFile$() : $m_Lscalajssupport_PhantomFile$()));
  return this
});
var $d_Lscalajssupport_File$ = new $TypeData().initClass({
  Lscalajssupport_File$: 0
...
$c_Lscalajssupport_File$.prototype.$classData = $d_Lscalajssupport_File$;
var $n_Lscalajssupport_File$ = (void 0);
function $m_Lscalajssupport_File$() {
  if ((!$n_Lscalajssupport_File$)) {
    $n_Lscalajssupport_File$ = new $c_Lscalajssupport_File$().init___()
  };
  return $n_Lscalajssupport_File$
}
/** @constructor */
function $c_Lscalajssupport_FileWriter() {
  $c_O.call(this);
  this.file$1 = null
}
$c_Lscalajssupport_FileWriter.prototype = new $h_O();
$c_Lscalajssupport_FileWriter.prototype.constructor = $c_Lscalajssupport_FileWriter;
/** @constructor */
function $h_Lscalajssupport_FileWriter() {
  /*<skip>*/
}
$h_Lscalajssupport_FileWriter.prototype = $c_Lscalajssupport_FileWriter.prototype;
$c_Lscalajssupport_FileWriter.prototype.append__jl_CharSequence__Lscalajssupport_FileWriter = (function(csq) {
  var this$2 = $m_Lscalajssupport_File$();
  var this$1 = this.file$1;
  var path = this$1.$$undfile$1.getPath__T();
  var data = $objectToString(csq);
  $m_Lscalajssupport_File$();
  var mode = "a";
  this$2.jsFile$1.write__T__T__T__V(path, data, mode);
  return this
});
$c_Lscalajssupport_FileWriter.prototype.init___Lscalajssupport_File__Z = (function(file, append) {
  this.file$1 = file;
  return this
});
function $as_Lscalajssupport_FileWriter(obj) {
  return (((obj instanceof $c_Lscalajssupport_FileWriter) || (obj === null)) ? obj : $throwClassCastException(obj, "scalajssupport.FileWriter"))
}
function $isArrayOf_Lscalajssupport_FileWriter(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lscalajssupport_FileWriter)))
}
function $asArrayOf_Lscalajssupport_FileWriter(obj, depth) {
  return (($isArrayOf_Lscalajssupport_FileWriter(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lscalajssupport.FileWriter;", depth))
}
var $d_Lscalajssupport_FileWriter = new $TypeData().initClass({
  Lscalajssupport_FileWriter: 0
}, false, "scalajssupport.FileWriter", {
  Lscalajssupport_FileWriter: 1,
  O: 1
});
$c_Lscalajssupport_FileWriter.prototype.$classData = $d_Lscalajssupport_FileWriter;
/** @constructor */
function $c_Lscoverage_Invoker$() {
  $c_O.call(this);
  this.scoverage$Invoker$$MeasurementsPrefix$1 = null;
  this.threadFiles$1 = null;
  this.ids$1 = null
}
$c_Lscoverage_Invoker$.prototype = new $h_O();
$c_Lscoverage_Invoker$.prototype.constructor = $c_Lscoverage_Invoker$;
/** @constructor */
function $h_Lscoverage_Invoker$() {
  /*<skip>*/
}
$h_Lscoverage_Invoker$.prototype = $c_Lscoverage_Invoker$.prototype;
$c_Lscoverage_Invoker$.prototype.init___ = (function() {
  $n_Lscoverage_Invoker$ = this;
  this.scoverage$Invoker$$MeasurementsPrefix$1 = "scoverage.measurements.";
  this.threadFiles$1 = new $c_jl_ThreadLocal().init___();
  this.ids$1 = ($m_Lscoverage_Platform$().ThreadSafeMap__scm_HashMap$(), new $c_scm_HashMap().init___());
  return this
});
$c_Lscoverage_Invoker$.prototype.measurementFile__T__Lscalajssupport_File = (function(dataDir) {
  return new $c_Lscalajssupport_File().init___T__T(dataDir, (("" + this.scoverage$Invoker$$MeasurementsPrefix$1) + ($m_jl_Thread$(), new $c_sjsr_RuntimeLong().init___I__I(1, 0))))
});
$c_Lscoverage_Invoker$.prototype.invoked__I__T__V = (function(id, dataDir) {
  if ((!this.ids$1.contains__O__Z(new $c_T2().init___O__O(dataDir, id)))) {
    var files = $as_scm_HashMap(this.threadFiles$1.get__O());
    if ((files === null)) {
      $m_Lscoverage_Platform$().ThreadSafeMap__scm_HashMap$();
      files = new $c_scm_HashMap().init___();
      this.threadFiles$1.set__O__V(files)
    };
    var this$2 = files;
    var hash = $m_sr_Statics$().anyHash__O__I(dataDir);
    var i = $f_scm_HashTable__index__I__I(this$2, hash);
    var firstEntry = this$2.findEntry__p5__O__I__scm_DefaultEntry(dataDir, i);
    if ((firstEntry !== null)) {
      var jsx$1 = firstEntry.value$1
    } else {
      var table0 = this$2.table$5;
      var $default = new $c_Lscalajssupport_FileWriter().init___Lscalajssupport_File__Z($m_Lscoverage_Invoker$().measurementFile__T__Lscalajssupport_File(dataDir), true);
      var newEntryIndex = ((table0 === this$2.table$5) ? i : $f_scm_HashTable__index__I__I(this$2, hash));
      var e = new $c_scm_DefaultEntry().init___O__O(dataDir, $default);
      var secondEntry = this$2.findEntry__p5__O__I__scm_DefaultEntry(dataDir, newEntryIndex);
      if ((secondEntry === null)) {
        this$2.addEntry__p5__scm_DefaultEntry__I__O(e, newEntryIndex)
      } else {
        secondEntry.value$1 = $default
      };
      var jsx$1 = $default
    };
    var writer = $as_Lscalajssupport_FileWriter(jsx$1);
    writer.append__jl_CharSequence__Lscalajssupport_FileWriter((("" + id) + new $c_jl_Character().init___C(10)));
    this.ids$1.put__O__O__s_Option(new $c_T2().init___O__O(dataDir, id), (void 0))
  }
});
var $d_Lscoverage_Invoker$ = new $TypeData().initClass({
  Lscoverage_Invoker$: 0
}, false, "scoverage.Invoker$", {
  Lscoverage_Invoker$: 1,
  O: 1
});
$c_Lscoverage_Invoker$.prototype.$classData = $d_Lscoverage_Invoker$;
var $n_Lscoverage_Invoker$ = (void 0);
function $m_Lscoverage_Invoker$() {
  if ((!$n_Lscoverage_Invoker$)) {
    $n_Lscoverage_Invoker$ = new $c_Lscoverage_Invoker$().init___()
  };
  return $n_Lscoverage_Invoker$
}
/** @constructor */
function $c_Lscoverage_Platform$() {
  $c_O.call(this);
  this.ThreadSafeMap$1 = null;
  this.Source$1 = null;
  this.bitmap$0$1 = 0
}
$c_Lscoverage_Platform$.prototype = new $h_O();
$c_Lscoverage_Platform$.prototype.constructor = $c_Lscoverage_Platform$;
/** @constructor */
function $h_Lscoverage_Platform$() {
  /*<skip>*/
}
$h_Lscoverage_Platform$.prototype = $c_Lscoverage_Platform$.prototype;
$c_Lscoverage_Platform$.prototype.init___ = (function() {
  return this
});
$c_Lscoverage_Platform$.prototype.ThreadSafeMap__scm_HashMap$ = (function() {
  return (((1 & this.bitmap$0$1) === 0) ? this.ThreadSafeMap$lzycompute__p1__scm_HashMap$() : this.ThreadSafeMap$1)
});
$c_Lscoverage_Platform$.prototype.ThreadSafeMap$lzycompute__p1__scm_HashMap$ = (function() {
  if (((1 & this.bitmap$0$1) === 0)) {
    this.ThreadSafeMap$1 = $m_scm_HashMap$();
    this.bitmap$0$1 = (1 | this.bitmap$0$1)
  };
  return this.ThreadSafeMap$1
});
var $d_Lscoverage_Platform$ = new $TypeData().initClass({
  Lscoverage_Platform$: 0
}, false, "scoverage.Platform$", {
  Lscoverage_Platform$: 1,
  O: 1
});
$c_Lscoverage_Platform$.prototype.$classData = $d_Lscoverage_Platform$;
var $n_Lscoverage_Platform$ = (void 0);
function $m_Lscoverage_Platform$() {
  if ((!$n_Lscoverage_Platform$)) {
    $n_Lscoverage_Platform$ = new $c_Lscoverage_Platform$().init___()
  };
  return $n_Lscoverage_Platform$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_Lscalajssupport_NodeFile() {
  $c_O.call(this);
  this.path$1 = null
}
$c_Lscalajssupport_NodeFile.prototype = new $h_O();
$c_Lscalajssupport_NodeFile.prototype.constructor = $c_Lscalajssupport_NodeFile;
/** @constructor */
function $h_Lscalajssupport_NodeFile() {
  /*<skip>*/
}
$h_Lscalajssupport_NodeFile.prototype = $c_Lscalajssupport_NodeFile.prototype;
$c_Lscalajssupport_NodeFile.prototype.init___T = (function(path) {
  this.path$1 = path;
  return this
});
$c_Lscalajssupport_NodeFile.prototype.getPath__T = (function() {
  return this.path$1
});
var $d_Lscalajssupport_NodeFile = new $TypeData().initClass({
  Lscalajssupport_NodeFile: 0
}, false, "scalajssupport.NodeFile", {
  Lscalajssupport_NodeFile: 1,
  O: 1,
  Lscalajssupport_JsFile: 1
});
$c_Lscalajssupport_NodeFile.prototype.$classData = $d_Lscalajssupport_NodeFile;
/** @constructor */
function $c_Lscalajssupport_NodeFile$() {
  $c_O.call(this);
  this.fs$1 = null;
  this.nodePath$1 = null
}
$c_Lscalajssupport_NodeFile$.prototype = new $h_O();
$c_Lscalajssupport_NodeFile$.prototype.constructor = $c_Lscalajssupport_NodeFile$;
/** @constructor */
...
$h_Lscalajssupport_NodeFile$.prototype = $c_Lscalajssupport_NodeFile$.prototype;
$c_Lscalajssupport_NodeFile$.prototype.init___ = (function() {
  $n_Lscalajssupport_NodeFile$ = this;
  this.fs$1 = $g.require("fs");
  this.nodePath$1 = $g.require("path");
  return this
});
$c_Lscalajssupport_NodeFile$.prototype.pathJoin__T__T__T = (function(path, child) {
  return $as_T(this.nodePath$1.join(path, child))
});
$c_Lscalajssupport_NodeFile$.prototype.write__T__T__T__V = (function(path, data, mode) {
  this.fs$1.writeFileSync(path, data, {
    "flag": mode
  })
});
$c_Lscalajssupport_NodeFile$.prototype.apply__T__Lscalajssupport_JsFile = (function(path) {
  return new $c_Lscalajssupport_NodeFile().init___T(path)
});
var $d_Lscalajssupport_NodeFile$ = new $TypeData().initClass({
  Lscalajssupport_NodeFile$: 0
}, false, "scalajssupport.NodeFile$", {
  Lscalajssupport_NodeFile$: 1,
  O: 1,
  Lscalajssupport_JsFileObject: 1
});
$c_Lscalajssupport_NodeFile$.prototype.$classData = $d_Lscalajssupport_NodeFile$;
var $n_Lscalajssupport_NodeFile$ = (void 0);
function $m_Lscalajssupport_NodeFile$() {
  if ((!$n_Lscalajssupport_NodeFile$)) {
    $n_Lscalajssupport_NodeFile$ = new $c_Lscalajssupport_NodeFile$().init___()
  };
  return $n_Lscalajssupport_NodeFile$
}
/** @constructor */
function $c_Lscalajssupport_PhantomFile() {
  $c_O.call(this);
  this.path$1 = null
}
$c_Lscalajssupport_PhantomFile.prototype = new $h_O();
$c_Lscalajssupport_PhantomFile.prototype.constructor = $c_Lscalajssupport_PhantomFile;
/** @constructor */
function $h_Lscalajssupport_PhantomFile() {
  /*<skip>*/
}
$h_Lscalajssupport_PhantomFile.prototype = $c_Lscalajssupport_PhantomFile.prototype;
$c_Lscalajssupport_PhantomFile.prototype.init___T = (function(path) {
  this.path$1 = path;
  return this
});
$c_Lscalajssupport_PhantomFile.prototype.getPath__T = (function() {
  return this.path$1
});
var $d_Lscalajssupport_PhantomFile = new $TypeData().initClass({
  Lscalajssupport_PhantomFile: 0
}, false, "scalajssupport.PhantomFile", {
  Lscalajssupport_PhantomFile: 1,
  O: 1,
  Lscalajssupport_JsFile: 1
});
$c_Lscalajssupport_PhantomFile.prototype.$classData = $d_Lscalajssupport_PhantomFile;
/** @constructor */
function $c_Lscalajssupport_PhantomFile$() {
  $c_O.call(this);
  this.separator$1 = null
}
$c_Lscalajssupport_PhantomFile$.prototype = new $h_O();
$c_Lscalajssupport_PhantomFile$.prototype.constructor = $c_Lscalajssupport_PhantomFile$;
/** @constructor */
...
$h_Lscalajssupport_PhantomFile$.prototype = $c_Lscalajssupport_PhantomFile$.prototype;
$c_Lscalajssupport_PhantomFile$.prototype.init___ = (function() {
  $n_Lscalajssupport_PhantomFile$ = this;
  this.separator$1 = $as_T(this.fsCall__T__sjs_js_Any__sjs_js_Dynamic("separator", null));
  return this
});
$c_Lscalajssupport_PhantomFile$.prototype.fsCall__T__sjs_js_Any__sjs_js_Dynamic = (function(method, arg) {
  return this.fsCallArray__T__sjs_js_Array__sjs_js_Dynamic(method, [arg])
});
$c_Lscalajssupport_PhantomFile$.prototype.pathJoin__T__T__T = (function(path, child) {
  return ((("" + path) + this.separator$1) + child)
});
$c_Lscalajssupport_PhantomFile$.prototype.fsCallArray__T__sjs_js_Array__sjs_js_Dynamic = (function(method, args) {
  var d = $g.callPhantom({
    "action": "require.fs",
    "method": method,
    "args": args
  });
  return $g.JSON.parse($as_T(d))
});
$c_Lscalajssupport_PhantomFile$.prototype.write__T__T__T__V = (function(path, content, mode) {
  this.fsCallArray__T__sjs_js_Array__sjs_js_Dynamic("write", [path, content, mode])
});
$c_Lscalajssupport_PhantomFile$.prototype.apply__T__Lscalajssupport_JsFile = (function(path) {
  return new $c_Lscalajssupport_PhantomFile().init___T(path)
});
var $d_Lscalajssupport_PhantomFile$ = new $TypeData().initClass({
  Lscalajssupport_PhantomFile$: 0
}, false, "scalajssupport.PhantomFile$", {
...
$c_Lscalajssupport_PhantomFile$.prototype.$classData = $d_Lscalajssupport_PhantomFile$;
var $n_Lscalajssupport_PhantomFile$ = (void 0);
function $m_Lscalajssupport_PhantomFile$() {
  if ((!$n_Lscalajssupport_PhantomFile$)) {
    $n_Lscalajssupport_PhantomFile$ = new $c_Lscalajssupport_PhantomFile$().init___()
  };
  return $n_Lscalajssupport_PhantomFile$
}
/** @constructor */
function $c_Lscalajssupport_RhinoFile() {
  $c_O.call(this);
  this.$$undfile$1 = null
}
$c_Lscalajssupport_RhinoFile.prototype = new $h_O();
$c_Lscalajssupport_RhinoFile.prototype.constructor = $c_Lscalajssupport_RhinoFile;
/** @constructor */
function $h_Lscalajssupport_RhinoFile() {
  /*<skip>*/
}
$h_Lscalajssupport_RhinoFile.prototype = $c_Lscalajssupport_RhinoFile.prototype;
$c_Lscalajssupport_RhinoFile.prototype.init___Lscalajssupport_NativeRhinoFile = (function(_file) {
  this.$$undfile$1 = _file;
  return this
});
$c_Lscalajssupport_RhinoFile.prototype.init___T = (function(path) {
  $c_Lscalajssupport_RhinoFile.prototype.init___Lscalajssupport_NativeRhinoFile.call(this, new $g.Packages.java.io.File(path));
  return this
});
$c_Lscalajssupport_RhinoFile.prototype.getPath__T = (function() {
  return ("" + this.$$undfile$1.getPath())
});
var $d_Lscalajssupport_RhinoFile = new $TypeData().initClass({
  Lscalajssupport_RhinoFile: 0
}, false, "scalajssupport.RhinoFile", {
  Lscalajssupport_RhinoFile: 1,
  O: 1,
  Lscalajssupport_JsFile: 1
});
$c_Lscalajssupport_RhinoFile.prototype.$classData = $d_Lscalajssupport_RhinoFile;
/** @constructor */
function $c_Lscalajssupport_RhinoFile$() {
  $c_O.call(this)
}
...
$h_Lscalajssupport_RhinoFile$.prototype = $c_Lscalajssupport_RhinoFile$.prototype;
$c_Lscalajssupport_RhinoFile$.prototype.init___ = (function() {
  return this
});
$c_Lscalajssupport_RhinoFile$.prototype.pathJoin__T__T__T = (function(path, child) {
  return ("" + new $g.Packages.java.io.File(path, child).getPath())
});
$c_Lscalajssupport_RhinoFile$.prototype.write__T__T__T__V = (function(path, data, mode) {
  var jsx$1 = $g.Packages.java.io.FileOutputStream;
  var value = (mode === "a");
  var outputstream = new jsx$1(path, value);
  var jString = new $g.Packages.java.lang.String(data);
  outputstream.write(jString.getBytes())
});
$c_Lscalajssupport_RhinoFile$.prototype.apply__T__Lscalajssupport_JsFile = (function(path) {
  return new $c_Lscalajssupport_RhinoFile().init___T(path)
});
var $d_Lscalajssupport_RhinoFile$ = new $TypeData().initClass({
  Lscalajssupport_RhinoFile$: 0
}, false, "scalajssupport.RhinoFile$", {
...
$c_Lscalajssupport_RhinoFile$.prototype.$classData = $d_Lscalajssupport_RhinoFile$;
var $n_Lscalajssupport_RhinoFile$ = (void 0);
function $m_Lscalajssupport_RhinoFile$() {
  if ((!$n_Lscalajssupport_RhinoFile$)) {
    $n_Lscalajssupport_RhinoFile$ = new $c_Lscalajssupport_RhinoFile$().init___()
  };
  return $n_Lscalajssupport_RhinoFile$
}
/** @constructor */
...
$m_Lorg_dt_Main$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=hello-fastopt.js.map
