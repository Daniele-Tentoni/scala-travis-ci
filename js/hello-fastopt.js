...
$c_Lorg_dt_Hello$.prototype = new $h_O();
$c_Lorg_dt_Hello$.prototype.constructor = $c_Lorg_dt_Hello$;
/** @constructor */
function $h_Lorg_dt_Hello$() {
  /*<skip>*/
}
$h_Lorg_dt_Hello$.prototype = $c_Lorg_dt_Hello$.prototype;
$c_Lorg_dt_Hello$.prototype.init___ = (function() {
  $n_Lorg_dt_Hello$ = this;
  $f_s_App__$$init$__V(this);
  var body = new $c_Lorg_dt_Hello$delayedInit$body().init___Lorg_dt_Hello$(this);
  this.scala$App$$initCode$1.$$plus$eq__O__scm_ListBuffer(body);
  return this
});
$c_Lorg_dt_Hello$.prototype.delayedEndpoint$org$dt$Hello$1__V = (function() {
  $m_Lscoverage_Invoker$().invoked__I__T__V(1, "/home/travis/build/Daniele-Tentoni/scala-travis-ci/target/scala-2.12/scoverage-data");
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Hello\n")
});
$c_Lorg_dt_Hello$.prototype.main__AT__V = (function(args) {
  $f_s_App__main__AT__V(this, args)
});
var $d_Lorg_dt_Hello$ = new $TypeData().initClass({
  Lorg_dt_Hello$: 0
}, false, "org.dt.Hello$", {
  Lorg_dt_Hello$: 1,
  O: 1,
...
$c_Lorg_dt_Hello$.prototype.$classData = $d_Lorg_dt_Hello$;
var $n_Lorg_dt_Hello$ = (void 0);
function $m_Lorg_dt_Hello$() {
  if ((!$n_Lorg_dt_Hello$)) {
    $n_Lorg_dt_Hello$ = new $c_Lorg_dt_Hello$().init___()
  };
  return $n_Lorg_dt_Hello$
}
/** @constructor */
function $c_Lorg_dt_Hello$delayedInit$body() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null
}
$c_Lorg_dt_Hello$delayedInit$body.prototype = new $h_sr_AbstractFunction0();
$c_Lorg_dt_Hello$delayedInit$body.prototype.constructor = $c_Lorg_dt_Hello$delayedInit$body;
/** @constructor */
function $h_Lorg_dt_Hello$delayedInit$body() {
  /*<skip>*/
}
$h_Lorg_dt_Hello$delayedInit$body.prototype = $c_Lorg_dt_Hello$delayedInit$body.prototype;
$c_Lorg_dt_Hello$delayedInit$body.prototype.apply__O = (function() {
  this.$$outer$2.delayedEndpoint$org$dt$Hello$1__V()
});
$c_Lorg_dt_Hello$delayedInit$body.prototype.init___Lorg_dt_Hello$ = (function($$outer) {
  if (($$outer === null)) {
...
var $d_Lorg_dt_Hello$delayedInit$body = new $TypeData().initClass({
  Lorg_dt_Hello$delayedInit$body: 0
}, false, "org.dt.Hello$delayedInit$body", {
  Lorg_dt_Hello$delayedInit$body: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1
});
$c_Lorg_dt_Hello$delayedInit$body.prototype.$classData = $d_Lorg_dt_Hello$delayedInit$body;
...
$m_Lorg_dt_Hello$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
